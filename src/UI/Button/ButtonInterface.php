...
interface ButtonInterface extends RenderableElementInterface, TriggerInterface, WithIdInterface, WithSizeInterface, WithTooltipInterface, WithVariantInterface
{
